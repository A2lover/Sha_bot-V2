...
Julie.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if (!!message.mention && message.mention[0] == '919526128516@s.whatsapp.net,919847530461@s.whatsapp.net') {
...
const array = ['asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Kill','kill','kiss','line','love','mwolu','mention','Mention','Mwolu','single','tha','thund','z','Z','bie','Bie','Kaztro','Sad','Poocha','Poda','Bomb','Ayin','Ariyo','Alone','Pubg','Pes','Bgmi','Ff','Free fire','chavanam','Manassilayo','Kodathi','Kollum','vatt','Gaanam','Single','Maalutty','Xxxtentacion','Aa','Pottan','Budhi','Love','Njan','Mazha','Vella','Patt','Colour','Hacker','Ok','tts','Hack','Hii']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
